        ...
        <aside className="ty-aside">
          <div className="ty-card">
            <div className="ty-card-head">
              <img src="/media/Logo.jpeg" alt="Vincula Tu Mente" className="ty-avatar" />
              <div>
            ...
            <div className="ty-card-body">
              ...
              <a href="mailto:hola@vinculatumente.com" className="ty-contact">
                ...
                <span className="ty-mail">hola@vinculatumente.com</span>
              </a>
