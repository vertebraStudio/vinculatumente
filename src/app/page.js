...
const compromiso = [
  ...
  { icon: 'lock', title: 'Confidencialidad y respeto', desc: 'Todo lo que se comparte queda protegido bajo el más estricto secreto profesional. Rigor y ética en cada sesión.' },
  ...
  { icon: 'people', title: 'Acompañamiento personalizado', desc: 'Diseñamos un proceso adaptado a cada persona y su ritmo. Nadie está solx en esto: avanzamos juntxs.' },
];
          ...
          <div className="container">
            <div className="terapia-intro-grid">
              <div className="therapy-text">
                <span className="eyebrow eyebrow-section"><span className="eyebrow-line" /><span className="eyebrow-ic">{lineIcons.heart}</span> Psicología y Sexología</span>
                <h2 className="section-title therapy-title">Áreas de intervención</h2>
                <p>Acompañamos a <strong>comprender, aceptar y vivir relaciones más sanas y conscientes</strong>, integrando lo emocional y lo sexual como parte de un mismo bienestar.</p>
                <p>Cada proceso es único. Partimos de la historia y los objetivos de cada persona para diseñar un acompañamiento personalizado, con herramientas prácticas aplicables en la vida cotidiana.</p>
                <p>Atención <strong>presencial en Alcalá de Henares</strong> y <strong>online</strong> desde cualquier punto de España, con la misma cercanía, rigor y confidencialidad.</p>
              </div>
              <div className="formation-box glass" style={{ border:'1px solid #e8dce6', padding:'28px 30px', display:'flex', flexDirection:'column', gap:'6px' }}>
                <h3 style={{ color:'var(--text)', marginBottom:'16px', fontFamily:"var(--font-playfair),serif", fontSize:'1.1rem' }}>Modalidades de sesión</h3>
                {[
                  ['Sesión individual',   '60 min'],
                  ['Terapia de pareja',   '60 min'],
                  ['Infanto-juvenil',     '45 – 60 min'],
                ...
                <p style={{ fontSize:'0.8rem', color:'var(--text-muted)', marginTop:'14px', lineHeight:1.6 }}>
                  Presencial en Alcalá de Henares · Online en toda España
                </p>
              </div>
            </div>
          ...
          <div className="container">
            <div className="terapia-intro-grid">
              <div className="therapy-text">
                ...
                <p>Diseñamos talleres, charlas y programas formativos sobre <strong>sexualidad, vínculos, salud mental e igualdad</strong> para empresas, centros educativos, entidades sociales y equipos profesionales.</p>
        ...
        <section id="compromiso" className="compromiso">
          ...
          <div className="container" style={{ position:'relative', zIndex:2 }}>
            <div style={{ textAlign:'center' }}>
              <span className="eyebrow eyebrow-center"><span className="eyebrow-line" /><span className="eyebrow-ic">{lineIcons.shield}</span> Nuestro enfoque <span className="eyebrow-line" /></span>
            </div>
