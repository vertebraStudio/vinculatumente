      ...
      <main style={{ paddingTop: '100px', minHeight: '80vh' }}>
        ...
        <section className="legal-section-header">
          <div className="container">
            ...
            <h1 style={{ fontSize: '2.5rem', fontFamily: "'Playfair Display', serif", color: 'var(--text)', marginTop: '10px', marginBottom: '10px' }}>Política de Cookies</h1>
          ...
          <div className="container">
            <div className="legal-content" style={{ maxWidth: '780px' }}>
              ...
              <LegalSection title="5. Actualización de la Política">
                <p>El titular puede modificar esta Política de Cookies en función de exigencias legislativas o para adaptarla a las instrucciones dictadas por la Agencia Española de Protección de Datos (AEPD). Para cualquier duda, puedes contactar en <a href="mailto:hola@vinculatumente.com">hola@vinculatumente.com</a>.</p>
              </LegalSection>
