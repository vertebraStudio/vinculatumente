...
export default async function sitemap() {
  ...
  return [
    ...
    { url: `${SITE}/talleres/`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${SITE}/talleres/particulares/`, lastModified: now, priority: 0.6 },
    { url: `${SITE}/talleres/familias/`, lastModified: now, priority: 0.6 },
    { url: `${SITE}/talleres/centros-educativos/`, lastModified: now, priority: 0.6 },
    { url: `${SITE}/talleres/empresas/`, lastModified: now, priority: 0.6 },
